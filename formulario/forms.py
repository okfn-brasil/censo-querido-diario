...
class PostCityForm(forms.ModelForm):
    ...
    class Meta:
        ...
        help_texts = {
            'municipio': 'Digite o nome do município que deseja cadastrar. Se ele não constar na lista disponível, significa que seu mapeamento já foi realizado. Saiba mais <a href="/faq/#faq-1">aqui</a>.',
            'is_online': 'É possível encontrar o diário oficial do município publicado em alguma página da internet? Caso não seja possível, clique <a href="/faq/#faq-5">aqui</a> para saber mais.',            
